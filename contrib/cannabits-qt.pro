...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cannabits-cli.cpp \
           src/cannabits-tx.cpp \
           src/cannabits.cpp \
           src/db.cpp \
           ...
           src/qt/cannabits.cpp \
           src/qt/cannabitsstrings.cpp \
...
RESOURCES += src/qt/cannabits.qrc src/qt/cannabits_locale.qrc

TRANSLATIONS += src/qt/locale/cannabits_bg.ts \
                src/qt/locale/cannabits_de.ts \
                src/qt/locale/cannabits_en.ts \
                src/qt/locale/cannabits_es.ts \
                src/qt/locale/cannabits_fi.ts \
                src/qt/locale/cannabits_fr.ts \
                src/qt/locale/cannabits_it.ts \
                src/qt/locale/cannabits_ja.ts \
                src/qt/locale/cannabits_pl.ts \
                src/qt/locale/cannabits_pt.ts \
                src/qt/locale/cannabits_ru.ts \
                src/qt/locale/cannabits_sk.ts \
                src/qt/locale/cannabits_sv.ts \
                src/qt/locale/cannabits_vi.ts \
                src/qt/locale/cannabits_zh_CN.ts \
                src/qt/locale/cannabits_zh_TW.ts
