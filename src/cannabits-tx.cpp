...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cannabits Core cannabits-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cannabits-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cannabits transaction") + "\n" +
                               "  cannabits-tx [options] -create [commands]   " + _("Create hex-encoded cannabits transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cannabits transaction
