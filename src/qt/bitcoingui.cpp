                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cannabits Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cannabits address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cannabits: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cannabits Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cannabits Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cannabits"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cannabits addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cannabits addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cannabits: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cannabits Core help message to get a list with possible CANNABITS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cannabits Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cannabits network", "", count));
}
...
{
    QString strTitle = tr("Cannabits Core"); // default title
