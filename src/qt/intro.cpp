...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cannabits Core"),
     ...
     * override -datadir in the cannabits.conf file in the default data directory
     * (to be consistent with cannabitsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
