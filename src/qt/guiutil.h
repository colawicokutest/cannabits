...
/** Utility functions used by the CANNABITS Qt UI.
 */
namespace GUIUtil
{
...
// Render CANNABITS addresses in monospace font
...
// Parse "cannabits:" URI into recipient object, return true on successful parsing
