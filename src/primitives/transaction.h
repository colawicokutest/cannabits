...
public:
    ...
    bool IsDust(CFeeRate minRelayTxFee) const
    {
        ...
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 10000 ucnbt per kB
        // and that means that fee per txout is 182 * 10000 / 1000 = 1820 ucnbt.
        // So dust is a txout less than 1820 *3 = 5460 upiv
        // with default -minrelaytxfee = minRelayTxFee = 10000 ucnbt per kB.
