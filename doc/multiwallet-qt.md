...
In order to support loading of multiple wallets in cannabits-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cannabits.cpp.
...
Changes to cannabits.cpp
----------------------
cannabits.cpp is the entry point into cannabits-qt, and as such, will require some minor modifications to provide hooks for
