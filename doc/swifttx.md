...
This mechanism has been integrated into Bitcore-Node-CANNABITS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CANNABITS-Project/insight-api-cannabits#web-socket-api](https://github.com/CANNABITS-Project/insight-api-cannabits#web-socket-api) 
* API: [https://github.com/CANNABITS-Project/insight-api-cannabits#swifttx-transactions](https://github.com/CANNABITS-Project/insight-api-cannabits#swifttx-transactions) 
...
By default, the CANNABITS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CANNABITS Core daemon:
