Contributing to Cannabits Core
==================================

The Cannabits Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cannabits Core project, and is not to be
confused with overall Cannabits Network Protocol consensus changes.

Whether a pull request is merged into Cannabits Core rests with the project merge
...
Patches that change Cannabits consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cannabits consensus, it must have been
...
The project leader is the release manager for each Cannabits Core release.
